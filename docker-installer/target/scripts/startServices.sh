...
chmod 666 ansible/playbook-start-services.yml ansible/ansible_inventory
ansible-playbook ansible/playbook-start-services.yml -i ansible/ansible_inventory
